...
namespace MicroFocus.Adm.Octane.Api.Core.Entities
{
    ...
    public class RunManualGherkin : Run
    {
        ...
        public RunManualGherkin()
            : base()
        {
        }

        public RunManualGherkin(EntityId id)
            : base(id)
        {
        }
        ...
        public TestGherkin Parent
        {
            get
            {
                return (TestGherkin)GetValue(TEST_FIELD);
            }
            set
            {
